...
public class FileScan {
    ...
    public static final String VIDEO_PATH_GONGYI = Environment.getExternalStorageDirectory().getPath() + File.separator + "2014";
    public static final String VIDEO_PATH_XIANJIANG = Environment.getExternalStorageDirectory().getPath() + File.separator + "2015";
    public static final String VIDEO_PATH_YULE = Environment.getExternalStorageDirectory().getPath() + File.separator + "2016";
